...
public class PlayerBattleService {
    ...
    public List<PlayerBattlePathInfoDto> getPlayerBattlePathInfoDtos(String playerId) {
        PlayerBattlePathInfoDto pathA = new PlayerBattlePathInfoDto()
                .withNodes(List.of(
                        new Node("A1", 1L, 2L, List.of(
                                new UnitsInfo("infantry", 10L, "player")
                        )),
                        new Node("A2", 2L, 3L, List.of(
        ...
        PlayerBattlePathInfoDto pathB = new PlayerBattlePathInfoDto()
                .withNodes(List.of(
                        new Node("B1", 5L, 1L, List.of(
                                new UnitsInfo("cavalry", 7L, "player")
                        )),
                        new Node("B2", 4L, 2L, List.of()),
                        new Node("B3", 6L, 3L, List.of(
                                new UnitsInfo("archer", 12L, "enemy")
                        )),
        ...
        PlayerBattlePathInfoDto pathC = new PlayerBattlePathInfoDto()
                .withNodes(List.of(
                        new Node("C1", 9L, 0L, List.of()),
                        new Node("C2", 10L, 1L, List.of(
                                new UnitsInfo("infantry", 20L, "enemy")
                        )),
                        new Node("C3", 8L, 2L, List.of()),
                        new Node("C4", 10L, 3L, List.of(
